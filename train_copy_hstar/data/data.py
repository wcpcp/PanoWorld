...
class SupervisedDataset(Dataset):
    ...
    def __getitem__(self, idx: int) -> Dict[str, Any]:
        ...
        if self.generation_eval and self.raw_generation_eval:
            ...
            target_yaw_interval = sample.get("target_yaw_interval", metadata.get("target_yaw_interval"))
            target_pitch_interval = sample.get("target_pitch_interval", metadata.get("target_pitch_interval"))
            return {
                ...
                "target_yaw_interval": copy.deepcopy(target_yaw_interval),
                "target_pitch_interval": copy.deepcopy(target_pitch_interval),
                "metadata": metadata,
            }
